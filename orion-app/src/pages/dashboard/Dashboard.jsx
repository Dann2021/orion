import { Activity, Edit2Icon, Folder, MoreHorizontal, SettingsIcon, User2Icon } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <Col className={"gap-5"}>
      ...
      <Card  className={"ronde-1  p-2 bloc-myn-10"}>
        <Card.Header style={style3} className={"aff-flex jc-sb ai-mil gap-3 mb-1 p-1 ronde"}>
          ...
          <Bouton  onClick={() => alert("Fonctionnalité à venir")} theme="sombre" taille={"min"} className={"ronde"}> 
            <MoreHorizontal size={20} />
          </Bouton>

        </Card.Header>
        <Card.Corps style={style} className={"mh- aff-flex ai-mil fd-col gap-5 p-5 ronde"}>
          <Input
